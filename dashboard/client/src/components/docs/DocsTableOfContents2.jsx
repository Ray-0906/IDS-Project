...
function DocsTableOfContents({ activeSection, onSectionClick }) {
  ...
  if (tableOfContents.length === 0) {
    return (
      <div className="hidden 2xl:block 2xl:w-64 flex-shrink-0">
        ...
        <div className="mt-8 pt-6 border-t border-[rgba(139,92,246,0.2)]">
          ...
          <div className="w-full bg-gray-800 rounded-full h-1">
            <motion.div
              ...
              initial={{ width: 0 }}
              animate={{ 
                width: `${((activeHeading ? tableOfContents.findIndex(item => item.id === activeHeading) + 1 : 0) / tableOfContents.length) * 100}%` 
              }}
